public class Test
{
    ...
    {
        Beam b = new Beam(L, "Fixed", "Fixed", Q);
        Assert.Equal(b.MA(), b.M(0));
        Assert.Equal(Q * L * L / 24, b.M(L / 2), 1e-12);
        Assert.Equal(b.MB(), b.M(L));
    }
