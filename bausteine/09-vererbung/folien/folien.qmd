...
[🎥](#){target="_blank"} Erklärvideo auf YouTube
...
- Interface `IComparable<T>` zum Sortieren von Listen [🌐](https://learn.microsoft.com/en-us/dotnet/api/system.icomparable)
