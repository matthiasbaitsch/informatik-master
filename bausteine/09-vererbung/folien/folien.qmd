...
[🎥](https://youtu.be/05kPiamBDW0){target="_blank"} Erklärvideo auf YouTube
...
[🎥](https://youtu.be/4i-SWfpriqs){target="_blank"} Erklärvideo auf YouTube
...
[🎥](https://youtu.be/K6i_iuxDhDI){target="_blank"} Erklärvideo auf YouTube
...
[🎥](https://youtu.be/_cmAOQaAcKI){target="_blank"} Erklärvideo auf YouTube
...
## Methoden überschreiben: `ToString()` {.smaller}
...
→ Standardmäßig Klassenname, wenig Informativ!


::: {.fragment}
[]{.down40}

### Lösung: Methode `ToString` überschreiben
...
- Klasse kann nur von einer Klasse erben, aber beliebig viele Interfaces implementieren

- In C# weit verbreitet – begegnen einem in Dokumentation und Beispielen häufig

- Name beginnt in der Regel mit großem I

- Interface `IComparable<T>` aus C# Klassenbibliothek zum Sortieren von Listen [🌐](https://learn.microsoft.com/en-us/dotnet/api/system.icomparable)

- Sie kennen bereits `IEnumerable<T>` aus Abschnitt Datenstrukturen [🌐](https://learn.microsoft.com/en-us/dotnet/api/system.collections.ienumerable)

[]{.down20}

→ Interfaces sollen Sie kennen, aber nicht selber anwenden
:::
:::

# Zusammenfassung und Auslassungen

[🎥](https://youtu.be/dQCj2qTQHy4){target="_blank"} Erklärvideo auf YouTube
