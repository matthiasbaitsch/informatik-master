...
[🎥](https://youtu.be/Y6Gbi2MnyqA){target="_blank"} Erklärvideo auf YouTube
...
[🎥](https://youtu.be/o7ke0naaOEs){target="_blank"} Erklärvideo auf YouTube
...
[🎥](https://youtu.be/m6MRTFmcua0){target="_blank"} Erklärvideo auf YouTube

## Arten von Schleifen

[]{.down200}

- `while` - Schleife: Etwas wiederholen, solange eine Bedingung erfüllt ist
- `for` - Schleife: Etwas eine vorgegebene Anzahl von Malen wiederholen
- `foreach` - Schleife: Alle Elemente einer Liste verarbeiten (später)
...
- `i++` ist Kurzform für `i += 1`
- Üblich für Laufvariablen `i, j, k, l`
...
Danach
```{.pseudocode}
 sum ist eine Näherung für das gesuchte Integral
```
:::
::: {.column width="30%"}
...
## Vergleich `for`-Schleife und `while`-Schleife

[]{.down40}

### Streng genommen ist die `for`-Schleife unnötig
...
→ Beide Versionen verhalten sich identisch

[]{.down40}

::: {.fragment}
### Regel für Wahl der Schleifenart

- `for`-Schleife, falls Anzahl der Schleifendurchläufe von vorneherein feststeht
    - Summation von Werten
    - Verarbeitung von Listen (später)
- `while`-Schleife für kompliziertere Fortsetzungsbedingung
    - Näherungsverfahren
:::

# Logische Ausdrücke

[🎥](https://youtu.be/XygJVyBNJfA){target="_blank"} Erklärvideo auf YouTube
...
[🎥](https://youtu.be/gECxRs-Rvmc){target="_blank"} Erklärvideo auf YouTube
...
- `if` und `else`: Anweisungen abhängig von Bedingung ausführen
...
→ Geht immer auch anders und führt oft zu schlecht verständlichem Code
:::

## Was wir nicht verwenden wollen

[]{.down100}

::: {.r-fit-text}
Die Wortkombination if-Schleife 🤯
:::
