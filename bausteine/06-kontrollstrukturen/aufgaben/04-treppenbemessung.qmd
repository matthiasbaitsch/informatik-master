...
- Auftritt <br/>
    $230\,\text{mm} \leq a \leq 370\,\text{mm}$
- Schrittmaßregel
...
1. Überprüfung: Geben Sie jeweils an, ob die Treppe zulässig ist beziehungsweise welche Regel verletzt wurde.
    ...
    - Sie benötigen das Ergebnis der Überprüfung an mehreren Stellen. Hier bieten sich boolesche Variablen an. Im Prinzip funktioniert das so:
