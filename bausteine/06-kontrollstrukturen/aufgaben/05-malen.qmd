...
Öffnen Sie die Datei `04-paint/Paint.cs` und führen Sie das Programm aus. Sie sehen in der Mitte des Bildes ein einzelnes grünes Pixel. Ändern Sie die Datei so, dass die dargestellte Grafik erzeugt wird.
...
- Ein [Erklärvideo](https://youtu.be/JP1gRGQYBT0){target="_blank"} zum Einstieg
:::
::::::
:::::::
