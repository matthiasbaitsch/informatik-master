...
[🎥](https://youtu.be/ZUKN_zhfKqw){target="_blank"} Erklärvideo auf YouTube
...
[🎥](https://youtu.be/Wm-96taGMJo){target="_blank"} Erklärvideo auf YouTube
...
::: {.columns}
::: {.column width=70%}
```{.xml filename="MainWindow.axaml" code-line-numbers="8-19"}
...
- `NumericUpDown`: Eingabe einer Zahl mit hoch/runter
:::
::: {.column}
...
[🎥](https://youtu.be/l3rijHLtab8){target="_blank"} Erklärvideo auf YouTube
...
::: {.columns}
::: {.column width=70%}
```{.xml filename="MainWindow.axaml" code-line-numbers="8-9,13-20|10-12|"}
...
::: {.columns}
::: {.column width=70%}
```{.xml filename="MainWindow.axaml" code-line-numbers="7-24"}
...
[🎥](https://youtu.be/pUAAYYsNScs){target="_blank"} Erklärvideo auf YouTube
...
- In diesem Zusammenhang ist `Click` ein Event (eine Benutzerinteraktion)
...
bool includeDeadWeight = this.DeadWeightCB.IsChecked == true;
```
...
- `ComboBox`: Index des gewählten Eintrags mit `SelectedIndex`
    - `SelectedItem!` liefert den Eintrag selbst, allerdings als `object` – daher Cast nach `string`
...
| `ComboBox`      | `SelectedItem`  | `object?`  | Gewählter Eintrag          |
...
[🎥](https://youtu.be/Ujek6YMn0Lw){target="_blank"} Erklärvideo auf YouTube
...
- Eingabe von strukturierten Daten
...
[🎥](https://youtu.be/TzZAUzsqpPM){target="_blank"} Erklärvideo auf YouTube
...
```xml
<TextBox x:Name="NameTB"/>
<CheckBox x:Name="DeadWeightCB">Eigengewicht berücksichtigen</CheckBox>
<Button x:Name="OkB">Ok</Button>
```
...
[🎥](https://youtu.be/3pCZyaP1FdM){target="_blank"} Erklärvideo auf YouTube
