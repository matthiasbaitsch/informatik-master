...
1. Schreiben Sie eine Methode `Apply`, die die Eingaben in das `SteelHall`-Objekt überträgt. Rufen Sie `Apply` beim Klick auf `Plot` und am Ende des Konstruktors auf.
:::
