...
### Diese Schreibweisen begegnen Ihnen häufig

- `op=` ist Kurzform für `variable = variable op wert`
...
- Alle Winkelfunktionen im Bogenmaß
...
| Beispiel Format | Bedeutung | `var` | Beispiel |
|-|-|-|-|
| `{var}` | Standardausgabe | `Math.PI` | `3,141592653589793` |
| `{var,17}` | Breite 17, rechtsbündig | `12345.6789` | `·······12345,6789` |
| `{var,-17}` | Breite 17, linksbündig | `12345.6789` | `12345,6789·······` |
| `{var:0.00000}` | Immer 5 Nachkommastellen | `Math.PI` | `3,14159` |
| | | `12345.6789` | `12345,67890` |
| `{var:0.#####}` | Maximal 5 Nachkommastellen | `Math.PI` | `3,14159` |
| | | `12345.6789` | `12345,6789` |
| `{var:+0.##;-0.##}` | Positiv/negativ mit zwei Stellen | `12345.6789` | `+12345,68` |
| `{var,17:0.#}` | Breite 15, eine Nachkommastelle | `12345.6789` | `··········12345,7` |
: {tbl-colwidths="[25,35,15,25]"}
