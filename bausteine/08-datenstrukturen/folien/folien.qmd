...
- Technische Anmerkung: Methoden stammen aus [LINQ](https://learn.microsoft.com/de-de/dotnet/csharp/linq/){target="_blank"}
...
- `height.Keys` – Liste aller Schlüssel, kann mit `foreach` durchlaufen werden
...
- [Array-Klassenreferenz](https://learn.microsoft.com/de-de/dotnet/api/system.array){target="_blank"}
- [LINQ-Dokumentation](https://learn.microsoft.com/de-de/dotnet/csharp/linq/){target="_blank"}
